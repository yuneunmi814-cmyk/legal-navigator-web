...
서식의 내용은 **MCP 서버가 원본**입니다. 이 저장소는 그걸 받아서
...
2. 서식 전종을 받아 `forms/` 에 페이지로 저장합니다 — 검색 노출용 제목·설명·canonical을 붙여서
...
> 법령·판례·용어 수는 도구 목록에 안 실려서 예전엔 손으로 적었고, 그래서 낡았습니다
> (2026-09-04 확인: 법령 258→실제 321, 절차 259→279, 서식 114→119).
> 지금은 빌드가 MCP의 `/healthz`에서 읽어 다시 씁니다. **숫자를 손으로 고치지 마세요.**
